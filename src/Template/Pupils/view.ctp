...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Pupil'), array('action' => 'delete', $pupil['Pupil']['id']), null, __('Are you sure you want to delete # {0}?', $pupil['Pupil']['id'])); ?> </li>
	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'results', 'action' => 'delete', $result['id']), null, __('Are you sure you want to delete # {0}?', $result['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'classrooms', 'action' => 'delete', $classroom['id']), null, __('Are you sure you want to delete # {0}?', $classroom['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
