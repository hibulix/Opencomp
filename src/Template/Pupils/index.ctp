<div class="pupils index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink('<button class="btn btn-danger btn-mini"><i class="fa fa-trash-o"></i> '.__('Supprimer').'</button>', array('action' => 'delete', $pupil['Pupil']['id']), array('escape' => false), __('Êtes vous sûr de vouloir supprimer # {0}?', $pupil['Pupil']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
