...
echo $this->Form->create('Pupil', array(
    'url' => '/pupils/runimport/'.$classroom_id,
));

echo $this->Form->hidden('first_name', ['value' => $column['first_name']]);
echo $this->Form->hidden('name', ['value' => $column['name']]);
echo $this->Form->hidden('birthday', ['value' => $column['birthday']]);
echo $this->Form->hidden('level', ['value' => $column['level']]);
echo $this->Form->hidden('sex', ['value' => $column['sex']]);
