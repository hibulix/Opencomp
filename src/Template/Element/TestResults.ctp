...
<table class="table table-striped">
    ...
    <tr>
        <?php foreach($competences as $competence): ?>
            <th style="padding: 5px; height:33px; " data-container="body" data-toggle="popover" title="C<?= $competence->EvaluationsCompetences['position'] ?>" data-trigger="hover" data-placement="bottom" data-content="<?= $competence->Competences['title'] ?>">
