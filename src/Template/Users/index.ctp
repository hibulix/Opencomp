<div class="users index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink('<button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> '.__('Supprimer').'</button>', array('action' => 'delete', $user['User']['id']), array('escape' => false), __('Êtes vous sûr de vouloir supprimer # {0}?', $user['User']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
