    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box <?= ($action == 'view') ? 'bg-blue' : '' ?>">
            <span class="info-box-icon <?= ($action == 'view') ? '' : 'bg-blue' ?>" style="opacity: 1">
                <?= $this->Html->link('<i class="fa fa-child"></i>', '/classrooms/view/' . $classroomId, ['style' => 'color:white;', 'escape' => false]); ?>
            </span>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box <?= ($action == 'viewtests') ? 'bg-green' : '' ?>">
            <span class="info-box-icon <?= ($action == 'viewtests') ? '' : 'bg-green' ?>">
                <?= $this->Html->link('<i class="fa fa-file-text-o"></i>', '/classrooms/viewtests/' . $classroomId, ['style' => 'color:white;', 'escape' => false]); ?>
            </span>
            <div class="info-box-content">
                <span class="info-box-text">Évaluations</span>
                <span class="info-box-number">
                    <?= $this->Html->link($evaluations, '/classrooms/viewtests/' . $classroomId, ['style' => 'color:inherit;']); ?>
                </span>
            </div>
            <!-- /.info-box-content -->
        </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box <?= ($action == 'viewunrateditems') ? 'bg-yellow' : '' ?>">
            <span class="info-box-icon <?= ($action == 'viewunrateditems') ? '' : 'bg-yellow' ?>">
                 <?= $this->Html->link('<i class="fa fa-check-square-o"></i>', '/classrooms/viewunrateditems/' . $classroomId, ['style' => 'color:white;', 'escape' => false]); ?>
            </span>
            <div class="info-box-content">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box <?= ($action == 'viewreports') ? 'bg-red' : '' ?>">
            <span class="info-box-icon <?= ($action == 'viewreports') ? '' : 'bg-red' ?>">
                <?= $this->Html->link('<i class="fa fa-file-pdf-o"></i>', '/classrooms/viewreports/' . $classroomId, ['style' => 'color:white;', 'escape' => false]); ?>
            </span>
