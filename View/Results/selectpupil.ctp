...
<div class="page-title">
    ...
    <?php echo $this->Html->link('<i class="fa fa-check"></i> '.__('J\'ai terminé la saisie'),  ['controller' => 'evaluations', 'action' => 'analyseresults', $evaluation_id], array('class' => 'ontitle btn btn-success', 'escape' => false)); ?>
</div>
